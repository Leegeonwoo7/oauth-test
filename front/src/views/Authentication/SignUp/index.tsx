...
import {EmailCertificationResponseDto, ResponseDto} from "../../../apis/response";
import {ResponseCode} from "../../../types/enums";
import {CheckCertificationRequestDto, EmailCertificationRequestDto, SignUpRequestDto} from "../../../apis/request/auth";
import {ResponseBody} from "../../../types";
import {CheckCertificationResponseDto, SignUpResponseDto} from "../../../apis/response/auth";
...
export default function SignUp() {
    ...
    const idCheckResponseDto = (responseBody: ResponseBody<IdCheckResponseDto>) => {
    ...
    const onSignUpButtonClickHandler = () => {
        ...
        if (!isCheckedPassword) {
            ...
            setPasswordMessage('영문,숫자를 혼용하여 8~13자리 입력해주세요');
            return;
        }
    ...
    const onIdButtonClickHandler = () => {
        ...
        idCheckRequest(requestBody).then(idCheckResponseDto);
    }

...
import {SignInInResponseDto} from "../../../apis/response/auth";
...
export default function SignIn() {
    ...
    const signInResponse = (responseBody: ResponseBody<SignInInResponseDto>) => {
        ...
        const { token, expirationTime } = responseBody as SignInInResponseDto;
